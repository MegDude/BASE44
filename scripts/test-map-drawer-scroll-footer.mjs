...
const checks = [
  ...
  ["shared shell runtime forces the grabber visible and centered", shell.includes('querySelector(".dp-native-detail-grabber")') && shell.includes('setProperty("display", "grid", "important")') && shell.includes('setProperty("left", "50%", "important")') && shell.includes('setProperty("transform", "translateX(-50%)", "important")')],
