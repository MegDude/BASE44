...
const checks = [
  ...
  ["shared shell runtime forces the grabber visible and centered", shell.includes('querySelector(".dp-native-detail-grabber")') && shell.includes('setProperty("display", "grid", "important")') && shell.includes('setProperty("visibility", "visible", "important")') && shell.includes('setProperty("opacity", "1", "important")') && shell.includes('setProperty("left", "50%", "important")') && shell.includes('setProperty("transform", "translateX(-50%)", "important")')],
  ["shared shell runtime locks close to the right grid column", shell.includes('querySelector(".dp-map-detail-close")') && shell.includes('setProperty("grid-column", "3", "important")') && shell.includes('setProperty("justify-self", "end", "important")')],
