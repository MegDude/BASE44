...
assert.match(appSource, /path="\/resident\/civic" element=\{<ResidentGovernance \/>\}/);
assert.match(appSource, /path="\/resident\/civic\/:actionId" element=\{<ResidentGovernance \/>\}/);
assert.match(appSource, /path="\/residents\/governance" element=\{<ResidentGovernance \/>\}/);
assert.doesNotMatch(appSource, /<ResidentHome/);
