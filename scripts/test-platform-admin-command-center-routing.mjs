...
assert.doesNotMatch(studio, /ADMIN_ACTION_TARGETS\[route\?\.id\] \|\| "\/partner-workspace/);
assert.match(studio, /ADMIN_ACTION_TARGETS\[route\?\.id\] \|\| "\/admin-studio\/command-center"/);
