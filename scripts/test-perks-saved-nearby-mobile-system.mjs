...
assert.match(mainSource, /active-perks-sheet-final\.css["'];?\s*\n\s*inject\(\)/, "The final Perks sheet stylesheet must load after shared UI layers before instrumentation");
