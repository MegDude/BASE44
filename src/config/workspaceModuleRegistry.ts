...
export const workspaceModules: readonly WorkspaceModuleDefinition[] = [
  ...
  { id: "map", label: "Partner map", description: "See your places, listings, routes, and nearby opportunities.", href: "/map?mode=partner&tab=map&filter=All", destination: "map", organizationTypes: ["property_group", "hospitality_group", "venue_group", "brand", "civic", "real_estate"], permissions: ["map:view"] },
  ...
  { id: "audience", label: "Audience", description: "See who you can reach and what they are doing.", href: "/partner-workspace/audience", destination: "performance", featureFlag: "analytics", permissions: ["audience:view"] },
  { id: "redemptions", label: "Redemptions", description: "Confirm QR uses and review completed resident perks.", href: "/partner-workspace/redemptions", destination: "performance", featureFlag: "qr", permissions: ["redemptions:view"] },
  ...
  { id: "media", label: "Photos and files", description: "Manage photos, logos, documents, floor plans, and campaign files.", href: "/partner-workspace/media", destination: "workspace", permissions: ["media:view"] },
