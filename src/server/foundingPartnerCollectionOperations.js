...
export const collectionPriorityTargets = [
  ...
  },
  {
    ...
    approvalRoute: "Kasidy Schaub — proposed Austin regional route; Andrea Willett — proposed executive escalation",
    operatingRoute: "SaraMarie Blunt, Jack Thuet, or Rikki Conner + the selected community manager; reconfirm all current roles",
    contactPath: "Verified WRMC association portal support: info4hoa@worthross.com · 855-435-4596. Use the company website or a documented warm introduction to reach portfolio leadership.",
    confidence: "The portal support channel is current and official. Portfolio leadership, direct outreach routes, operating contacts, and association approval authority require verification.",
    ...
    sources: [
      ["Worth Ross", "https://worthross.com/"],
      ["WRMC portal help", "https://home.worthross.com/Home_v2/Help"],
    ],
  },
  {
    id: "dunlap",
