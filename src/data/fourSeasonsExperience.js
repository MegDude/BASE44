...
export const FOUR_SEASONS_EXPERIENCE_ENTITIES = [
  ...
  fourSeasonsEntity({
    ...
    kind: "perk",
    category: "Hotel experiences nearby",
    subcategory: "Hotel dining experience nearby",
    residentLabel: "Hotel dining experience nearby",
    title: "Flights & Bites at Ciclo",
    lat: 30.26182,
    lng: -97.74208,
    imageUrl: IMAGES.flights,
    eyebrow: "Hotel experiences nearby · Downtown Core",
    headline: "Flights & Bites",
    subhead: "Hotel dining experience nearby",
    description: "A hotel dining experience featuring curated tastings and elevated downtown hospitality.",
