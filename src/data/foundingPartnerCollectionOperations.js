...
export const collectionPriorityTargets = [
  {
    ...
    approvalRoute: "Renee Zahn — Greystar Central West; Jonathan Reyes — LV Collective",
    operatingRoute: "Jarrod Byer — Paseo; Louie Colella — LV property management",
    ...
    confidence: "Named public routes; joint signing, legal, and resident-communications authority require confirmation.",
    nextAction: "Confirm the signer, resident-communications owner, legal/vendor review, and one follow-on Austin property.",
  ...
  },
  {
    ...
    confidence: "Company channels are available. Kasidy Schaub’s current title, portfolio scope, and direct route require verification.",
  ...
  },
  {
    ...
    approvalRoute: "Bridget Dunlap",
    operatingRoute: "One portfolio operations or marketing lead + one lead at each participating venue",
    contactPath: "Supplied working route: bridget@dunlapatx.com. Clive: clivemgmt@dunlapatx.com. Lustre Pearl East: lpemgmt@dunlapatx.com · 512-524-1143. Reconfirm before sending.",
    confidence: "Warm founder route. Venue-level ownership and the preferred first two concepts require confirmation.",
  ...
  },
  {
    ...
    approvalRoute: "Gregg Walker — asset management; Jack Bossung — Austin route",
    operatingRoute: "Tina Snyder + the current Frost Bank Tower property or tenant-experience lead",
    contactPath: "DivcoWest corporate line: 415-284-5700. Use Travis Dunaway at Endeavor as the proposed warm opening route.",
    confidence: "Current asset and local operating authority must be confirmed before outreach claims are made.",
    nextAction: "Confirm the asset decision-maker, property manager, tenant-experience owner, and tenant communications channel.",
  ...
  },
  {
    ...
    operatingRoute: "Steph “SJ” Carcamo + one assigned account owner",
    contactPath: "support@inkind.com. Social-impact route: impact@inkind.com. Warm introduction preferred for cohort approval.",
    confidence: "Names and company routes are available. Cohort authority, current participating venues, and reporting scope require direct confirmation.",
    nextAction: "Confirm the approved venue cohort, program evidence, one account owner, and reporting expectations.",
    ...
    sources: [["inKind", "https://inkind.com/"]],
  },
  {
    id: "white-lodging",
    name: "White Lodging",
    ...
    approvalRoute: "David Meisner — regional route; Thomas Hoffmann — Austin Marriott Downtown VP/GM route",
    ...
    confidence: "Property and regional routes are named. Execution owners and authority require direct confirmation.",
  ...
  },
  {
    ...
    approvalRoute: "Tony Montero — CEO; Tyson Cole — founder-level sponsor",
    operatingRoute: "Amber Quist — brand; Leo Barrera — operations",
    contactPath: "info@haihospitality.com. Uchibā Austin: 512-916-4808.",
    confidence: "Approval, brand, and operating routes are named. The pilot offer and day-to-day owner require confirmation.",
    ...
    sources: [
      ["Hai Hospitality", "https://www.haihospitality.com/"],
  ...
  },
  {
    ...
    approvalRoute: "Bart Knaggs — CEO and partner; Leigh Hitz — COO escalation",
    operatingRoute: "Sarah Swenson + Mindi Marshall + the current South Congress Hotel GM",
    contactPath: "Use New Waterloo’s official contact or work-with-us route. No direct personal email is treated as confirmed.",
    confidence: "Portfolio routes are named. The property GM, direct contact path, and final approval model require confirmation.",
    nextAction: "Name the property GM, confirm the warm route, and define one hotel-plus-dining local experience.",
    ...
    sources: [["New Waterloo", "https://newwaterloo.com/"]],
  },
];
...
export const collectionAdditionalRoutes = [
  ...
  },
  {
    ...
    contactPath: "MMiller@LPC.com · SJohnston@LPC.com · TRWilliams@LPC.com",
  },
  {
