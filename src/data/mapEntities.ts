...
export const MAP_ENTITIES: MapEntity[] = [
  ...
  {
    id: 'brand-fine-eyewear-campaign',
    name: 'Fine Eyewear',
    type: 'brand',
    description: 'Neighborhood wellness campaign anchored to DANA, Waterloo Greenway, hotel referrals, and the Downtown Walking Map.',
    location: { latitude: 30.2662, longitude: -97.7426, valid: true },
    ...
    iconType: 'services',
    metadata: {
      tags: ['fine eyewear', 'dana', 'walking map', 'local lens rate', 'waterloo'],
      searchKeywords: ['Fine Eyewear', 'DANA', 'Waterloo Greenway', 'hotel referrals', 'resident campaign'],
      askMapIntentTags: ['brand activation', 'resident wellness', 'civic partner', 'vision care'],
    },
    quickActions: ['save', 'details'],
    detailDrawerType: 'brand',
    createdAt: '2026-04-24T00:00:00Z',
    updatedAt: '2026-04-24T00:00:00Z',
  },
  {
    id: 'brand-kendra-scott-activation',
    name: 'Kendra Scott',
    type: 'brand',
    description: 'South Congress retail activation tied to district events, hotel partnerships, and resident gifting moments.',
    location: { latitude: 30.24983, longitude: -97.749901, valid: true },
    address: '1400 South Congress Avenue, Austin, TX 78704',
    district: 'congress',
    isBrand: true,
    isPlotted: true,
    isVisibleInResults: true,
    ...
    iconType: 'retail',
    metadata: {
      tags: ['kendra scott', 'retail', 'district activation', 'gifting'],
      searchKeywords: ['Kendra Scott', 'SoCo', 'retail activation', 'downtown partner'],
      askMapIntentTags: ['brand activation', 'retail', 'resident perks'],
    },
    quickActions: ['save', 'details'],
    detailDrawerType: 'brand',
    createdAt: '2026-04-24T00:00:00Z',
  ...
  },
  {
    ...
    name: 'DANA',
    type: 'civic',
    description: 'Downtown Austin Neighborhood Association trust layer used for resident distribution, building introductions, and community-first partner activations.',
    location: { latitude: 30.2668, longitude: -97.7428, valid: true },
    address: 'Downtown Austin, TX 78701',
    district: 'congress',
    isCivic: true,
    isPlotted: true,
    ...
    iconType: 'spark',
    metadata: {
      tags: ['DANA', 'residents', 'community', 'buildings'],
      searchKeywords: ['Downtown Austin Neighborhood Association', 'DANA', 'resident network'],
      askMapIntentTags: ['civic', 'resident network', 'community'],
    },
    quickActions: ['details'],
    detailDrawerType: 'brand',
    createdAt: '2026-04-24T00:00:00Z',
    updatedAt: '2026-04-24T00:00:00Z',
  },
  {
    ...
    type: 'civic',
    description: 'District operations and activation partner connecting brands, civic programming, and downtown behavior across the core.',
    location: { latitude: 30.2671, longitude: -97.7421, valid: true },
    address: 'Downtown Austin, TX 78701',
    district: 'congress',
    isCivic: true,
    isPlotted: true,
    ...
    iconType: 'spark',
    metadata: {
      tags: ['DAA', 'district operations', 'downtown alliance'],
      searchKeywords: ['Downtown Austin Alliance', 'DAA', 'district activation'],
      askMapIntentTags: ['civic', 'district', 'activation'],
    },
    quickActions: ['details'],
    detailDrawerType: 'brand',
    createdAt: '2026-04-24T00:00:00Z',
  ...
  },
  {
    ...
    type: 'civic',
    description: 'Public-space activation corridor for resident programs, civic moments, wellness events, and brand utility placements.',
    location: { latitude: 30.271515, longitude: -97.734993, valid: true },
    address: '1111 Red River Street, Austin, TX 78701',
    district: 'red-river',
    isCivic: true,
    isPlotted: true,
    isVisibleInResults: true,
    ...
    iconType: 'spark',
    metadata: {
      tags: ['waterloo greenway', 'civic activation', 'public space'],
      searchKeywords: ['Waterloo Greenway', 'public space', 'walking map'],
      askMapIntentTags: ['civic', 'events', 'wellness', 'activation'],
    },
    quickActions: ['save', 'details'],
    detailDrawerType: 'brand',
    createdAt: '2026-04-24T00:00:00Z',
  ...
  {
    id: 'civic-waterloo-park',
    name: 'Waterloo Park',
    type: 'civic',
    description: 'Live civic and wellness anchor for resident programming, QR-led activations, and downtown event discovery.',
    location: { latitude: 30.274131, longitude: -97.73592, valid: true },
    ...
    iconType: 'wellness',
    metadata: {
      tags: ['waterloo park', 'wellness', 'events', 'resident loop'],
      searchKeywords: ['Waterloo Park', 'yoga', 'downtown events', 'resident programming'],
      askMapIntentTags: ['events', 'wellness', 'civic', 'outdoors'],
    },
    quickActions: ['save', 'rsvp', 'details'],
    detailDrawerType: 'brand',
    createdAt: '2026-04-24T00:00:00Z',
    updatedAt: '2026-04-24T00:00:00Z',
  },
