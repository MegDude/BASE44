...
export const mapIconRegistry: Record<MapIconKey, MapIconDefinition> = {
  coffee: { label: "Coffee", glyph: icon('<path d="M4 8h13v7a5 5 0 0 1-5 5H9a5 5 0 0 1-5-5V8Z"/><path d="M17 10h1a3 3 0 0 1 0 6h-1"/><path d="M7 3v2M11 3v2M15 3v2"/>') },
  ...
  property: { label: "Property", glyph: icon('<path d="M4 21V5a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v16"/><path d="M8 7h2M14 7h2M8 11h2M14 11h2M8 15h2M14 15h2"/><path d="M9 21v-3h6v3"/>') },
  residential: { label: "Residential", glyph: icon('<path d="M3 11 12 4l9 7"/><path d="M5 10v11h14V10"/><path d="M9 21v-6h6v6"/>') },
  building: { label: "Building", glyph: icon('<path d="M4 21V5a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v16"/><path d="M8 7h2M14 7h2M8 11h2M14 11h2M8 15h2M14 15h2"/><path d="M9 21v-3h6v3"/>') },
  listing: { label: "Listing", glyph: icon('<path d="M3 11 12 4l9 7"/><path d="M5 10v11h14V10"/><path d="M9 21v-6h6v6"/>') },
  ...
  "happy-hour": { label: "Happy Hour", glyph: icon('<path d="M6 3h12l-5 7v8"/><path d="M9 21h6"/><path d="M8 8h8"/><path d="M18 4l-3 4"/>') },
  civic: { label: "Civic", glyph: icon('<path d="M3 10h18"/><path d="M5 10l7-6 7 6"/><path d="M6 10v9M10 10v9M14 10v9M18 10v9"/><path d="M4 21h16"/>') },
  retail: { label: "Retail", glyph: icon('<path d="M6 7V5a6 6 0 0 1 12 0v2"/><path d="M4 7h16l-1 14H5L4 7Z"/><path d="M9 11h.01M15 11h.01"/>') },
