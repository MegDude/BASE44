      ...
      <section className="dp-about-hero">
        <div className="dp-about-inner">
          ...
          >
            ...
            <p className="dp-about-kicker dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">A resident-first layer for deciding where to go, what to use, and what is worth putting on the calendar.</p>
            <p>
