      ...
      <div className="relative min-h-[108px] overflow-hidden md:min-h-[66px]">
        <AnimatePresence mode="wait" initial={false}>
          ...
          >
            ...
            <Link to={current.href} className="font-body text-[11px] font-bold uppercase tracking-normal text-[#0B1F33] transition-colors hover:text-[#A98B4A]">
              {current.cta}
  ...
  return (
    <div className="grid gap-5 rounded-[2px] border border-[#0B1F33]/8 bg-white p-5 shadow-[0_14px_34px_rgba(6,27,51,0.04)] md:grid-cols-[1fr_220px] md:p-7">
      <div>
        ...
        <Link to="/card" className="mt-6 inline-flex h-10 items-center justify-center gap-2 rounded-[2px] bg-[#0B1F33] px-5 text-[13px] font-medium text-white transition-colors hover:bg-[#0B1F33]">
          Get Your Perks Card
    ...
    <div className="rounded-[2px] border border-[#0B1F33]/8 bg-white p-5 md:p-7">
      <div className="grid gap-6 md:grid-cols-[0.85fr_1.15fr]">
        ...
        <form className="grid gap-3">
          ...
          <button type="button" className="mt-2 inline-flex h-10 items-center justify-center gap-2 rounded-[2px] bg-[#0B1F33] px-5 text-[13px] font-medium text-white transition-colors hover:bg-[#0B1F33]">
            Get My Perks Card
            <ArrowRight className="h-4 w-4" />
          </button>
        </form>
