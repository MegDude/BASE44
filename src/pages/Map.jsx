Warning: truncated output (original token count: 230557)
Total output lines: 19534
...
function PanelContext({ place, mode }) {
  ...
  if (isBatheEntity(place)) {
    return (
      <DestinationSection title="Why it matters" className="dp-property-o…30557 tokens truncated…    await navigator.share({ title: place.name, text: place.summary || place.description || place.name, url: shareUrl });
        return;
      }
      await navigator.clipboard?.writeText?.(shareUrl);
    } catch {
