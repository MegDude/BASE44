...
export default function ResidentMembership() {
  ...
  return <main className="dp-membership-page">
    <section className="dp-membership-hero" aria-labelledby="membership-title">
      <div>
        <p className="dp-membership-eyebrow">Residents</p>
    ...
    <section className="dp-membership-includes" aria-labelledby="membership-includes-title">
      <div><p className="dp-membership-eyebrow">What is included</p><h2 id="membership-includes-title">Your downtown, ready when you are.</h2></div>
    ...
    <section className="dp-membership-join" id="join" aria-labelledby="join-title">
      <div className="dp-membership-plan">
        <p className="dp-membership-eyebrow">Resident membership</p><h2 id="join-title">Everything included.</h2>
      ...
      <div className="dp-membership-building">
        <p className="dp-membership-eyebrow">Start with where you live</p><h2>See whether your building includes membership.</h2>
