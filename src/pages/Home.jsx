    ...
    <section className="dp-community-stories-section py-12 md:py-16" aria-labelledby="community-stories-title">
      <div className="dp-layout-shell">
        <div className="mb-7 max-w-2xl">
          <span className="dp-label mb-3 block dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">Resident Favorite</span>
  ...
  return (
    <main className="dp-home-page bg-white text-[#0B1F33]">
        ...
        <div className="relative dp-layout-shell">
          <div className="dp-marketing-hero-grid">
            <div className="dp-marketing-hero-copy">
              <span className="dp-label mb-4 block dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">{hero.eyebrow}</span>
              <h1>{hero.title}</h1>
          ...
          <div className="dp-marketing-value-grid">
            {marketingValueSections.map((section) => (
              <article key={section.eyebrow} className="dp-marketing-value-panel">
                <span className="dp-label dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">{section.eyebrow}</span>
                <h2>{section.title}</h2>
                <p>{section.body}</p>
                <ul>
      ...
      <section className="dp-marketing-partner-types">
        <div className="dp-layout-shell">
          <div className="dp-marketing-section-head">
            <span className="dp-label dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">Partner Types</span>
      ...
      <section className="py-12 md:py-16">
        <div className="dp-layout-shell">
          {!isPartner ? (
            <>
              <div className="mb-7 max-w-2xl">
                <span className="dp-label mb-3 block dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">Residents</span>
            ...
            <>
              <div className="mb-7 max-w-3xl">
                <span className="dp-label mb-3 block dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">Your role</span>
                ...
                <article className="bg-white p-6 shadow-[0_18px_56px_rgba(11,31,51,0.055),0_0_32px_rgba(191,164,106,0.05)]">
                  <div className="grid gap-5 md:grid-cols-[1fr_220px]">
                    ...
                    <div className="bg-white p-4 shadow-[0_14px_44px_rgba(11,31,51,0.05),0_0_26px_rgba(191,164,106,0.045)]">
                      <div className="text-[#0B1F33]/50 dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">Pricing</div>
      ...
      <section id="pricing" className="relative overflow-hidden bg-white py-12 text-[#0B1F33] shadow-[0_-18px_60px_rgba(11,31,51,0.045),0_0_44px_rgba(191,164,106,0.045)] md:py-16">
        ...
        <div className="dp-layout-shell grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="relative">
            <span className="dp-label mb-3 block dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">Pricing</span>
      ...
      <section className="py-12 md:py-16">
        <div className="dp-layout-shell">
          <div className="mb-7 max-w-2xl">
            <span className="dp-label mb-3 block dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">{isPartner ? "Partner questions" : "Resident questions"}</span>
      ...
      <section id="contact" className="relative py-12 md:py-16">
        ...
        <div className="dp-layout-shell grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
          <div>
            <span className="dp-label mb-3 block dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">{isPartner ? "Partner access" : "Resident access"}</span>
            <h2 className="font-heading text-3xl font-medium">
