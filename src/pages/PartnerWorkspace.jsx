...
function ProfileSection({ user, setUser }) {
  ...
  const defaultStory = "Add a clear, useful description of what people can discover here.";
  const defaultAction = "Add the next action people can take when they discover this place.";
  const [form, setForm] = useState(() => ({
    ...(storedProfile),
    ...
    public_summary: user?.public_summary || user?.bio || storedProfile.public_summary || "",
    public_action: user?.public_action || storedProfile.public_action || "",
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      public_summary: user?.public_summary || user?.bio || latestStoredProfile.public_summary || "",
      public_action: user?.public_action || latestStoredProfile.public_action || "",
