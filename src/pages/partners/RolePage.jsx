  ...
  return (
    <main className="min-h-screen bg-[#F7F8FB] px-5 py-16 text-[#071B2F] md:px-10">
      <section className="mx-auto grid max-w-5xl gap-8 rounded-[18px] border border-[rgba(7,27,47,0.08)] bg-white p-6 md:grid-cols-[1.2fr_.8fr] md:p-10">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[#BFA46A]">{config.label}</p>
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <Link to={`/partners/campaigns?type=${campaignType}#launch-campaign`} className="inline-flex h-11 items-center justify-center rounded-[10px] bg-[#071B2F] px-5 text-[12px] font-bold uppercase tracking-[0.1em] text-white">{config.cta}</Link>
