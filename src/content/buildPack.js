export const BUILD_PACK_SECTIONS = [
  ...
  },
  {
    ...
    intro:
      "The spec references a clean Next.js rebuild. The live product you have open at 127.0.0.1:4175 is a Vite/React Router app. This build pack keeps the product rules from the spec but maps them onto the actual repo and route structure that exists today.",
    blocks: [
      {
        type: "grid",
