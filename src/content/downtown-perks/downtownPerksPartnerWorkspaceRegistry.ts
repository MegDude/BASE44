...
export const PARTNER_ROUTES = {
  ...
  workspaceReports: "/app/workspace/reports",
...
export const PARTNER_WORKSPACE_NAV: Array<{ id: PartnerWorkspaceTab; label: string; href: string; helper: string }> = [
  ...
  { id: "reports", label: "Performance", href: PARTNER_ROUTES.workspaceReports, helper: "Turn activity into next actions." },
  { id: "analytics", label: "Analytics", href: PARTNER_ROUTES.workspaceAnalytics, helper: "Analyze audience, places, campaigns, sources, and geography." },
