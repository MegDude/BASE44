  ...
  return (
    <div className="space-y-3">
      ...
      {events.map((event, idx) => (
        <motion.div
          key={event.id}
          className="rounded-[20px] bg-white/72 backdrop-blur-sm border border-white/40 shadow-[0_2px_8px_rgba(17,31,61,0.06)] p-4 hover:shadow-[0_8px_24px_rgba(17,31,61,0.1)] transition-all cursor-pointer"
