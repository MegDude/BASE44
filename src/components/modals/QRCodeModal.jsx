  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 w-8 h-8 rounded-xl bg-secondary hover:bg-secondary/80 flex items-center justify-center transition-colors"
        >
        ...
        <AnimatePresence mode="wait">
          ...
          {state === 'confirming' && (
            ...
            >
              <div className="w-12 h-10 border-4 border-primary/30 border-t-primary rounded-xl animate-spin mx-auto mb-4" />
          ...
          {state === 'success' && (
            ...
            >
              <motion.div
                ...
                className="w-16 h-16 rounded-xl bg-primary/20 flex items-center justify-center mx-auto"
              >
          ...
          {state === 'error' && (
            <motion.div
              ...
              className="text-center space-y-4"
            >
              <div className="w-12 h-10 rounded-xl bg-destructive/20 flex items-center justify-center mx-auto">
