        ...
        {isSplit ? (
          <div className="grid grid-cols-1 md:grid-cols-[1fr_1.6fr] gap-10 items-start">
            ...
            >
              ...
              <h2 className={`font-heading text-3xl md:text-4xl font-medium leading-[1.1] tracking-normal mb-5 ${isDark ? "text-[#FFFFFF]" : "text-foreground"}`}>
                {sectionTitle}
              </h2>
              {sectionIntro && (
          ...
          <>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                <h2 className={`font-heading text-3xl md:text-4xl font-medium leading-[1.1] tracking-normal ${isDark ? "text-[#FFFFFF]" : "text-foreground"}`}>
                  {sectionTitle}
                </h2>
                {sectionIntro && (
