  ...
  return (
    <section className="dp-analytics-page" aria-labelledby="partner-analytics-title">
      <header className="dp-analytics-header">
        <div>
          <p className="dp-analytics-eyebrow text-[11px] uppercase text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">{workspace.name}</p>
  ...
  return (
    <div className="dp-analytics-overview">
      <section className="dp-analytics-decision-summary" aria-labelledby="decision-summary-title">
        <p className="dp-analytics-eyebrow text-[11px] uppercase text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">Decision summary</p>
...
function AnalyticsDeepView({ eyebrow, title, description, children }) { return <div className="dp-analytics-deep-view"><header><p className="dp-analytics-eyebrow text-[11px] uppercase text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">{eyebrow}</p><h2>{title}</h2><p>{description}</p></header>{children}</div>; }
function SectionHeading({ eyebrow, title, id }) { return <div className="dp-analytics-section-heading"><p className="dp-analytics-eyebrow text-[11px] uppercase text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">{eyebrow}</p><h2 id={id}>{title}</h2></div>; }
