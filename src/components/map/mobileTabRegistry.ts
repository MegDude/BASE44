...
export const residentMobileTabs: readonly MobileTabDefinition[] = [
  ...
  { id: "map", label: "Map", purpose: "Discovery and decisions in geographic context.", route: "/map?mode=resident&tab=map&filter=Featured&collection=downtown-perks-featured", emptyTitle: "Move the map or choose a category to explore downtown.", emptyAction: "Reset filters", analyticsEvent: "resident_map_open", sections: ["Current search intent", "Active filters", "Nearby categories", "Walking routes", "Recent searches", "Current district", "Map legend"] },
  { id: "perks", label: "Perks", purpose: "Discover and use verified resident benefits.", route: "/map?mode=resident&tab=perks&filter=Perks&collection=resident-benefits", emptyTitle: "No active perks match these filters.", emptyAction: "Try another category", analyticsEvent: "resident_perks_open", sections: ["Featured perk", "Available now", "Near me", "Resident-only", "Building-specific", "Dining", "Wellness", "Shopping", "Hotels", "Expiring soon", "Recently used"] },
  { id: "events", label: "Events", purpose: "Decide what to attend and act quickly.", route: "/map?mode=resident&tab=events&filter=Events&collection=events-nearby", emptyTitle: "Nothing is scheduled nearby for this date.", emptyAction: "Choose another date", analyticsEvent: "resident_events_open", sections: ["Happening today", "Starting soon", "This weekend", "Nearby", "Resident events", "Music", "Food and drink", "Culture", "Wellness", "Civic", "Saved events"] },
  { id: "card", label: "Card", purpose: "Resident identity, eligibility, and redemption.", route: "/map?mode=resident&tab=card", emptyTitle: "Activate resident access to show your Downtown Perks Card.", emptyAction: "Activate card", analyticsEvent: "resident_card_open", sections: ["Resident QR", "Card status", "Resident ID", "Building", "Eligibility", "Active perks", "Recent redemptions", "Help and support"] },
] as const;
...
export const partnerMobileTabs: readonly MobileTabDefinition[] = [
  ...
  { id: "insights", label: "Ask", purpose: "Ask what is working, who you are reaching, and what to do next.", route: "/partner-workspace/assistant", emptyTitle: "Recommendations appear after your listing or content receives activity.", emptyAction: "Open partner map", analyticsEvent: "partner_insights_open", sections: ["Reach", "Map views", "Saves", "Directions", "Redemptions", "Audience", "Recommendations"] },
