        ...
        {FILTER_CHIPS.map((chip) => {
          ...
          return (
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className={`snap-start shrink-0 md:shrink inline-flex items-center gap-1.5 h-10 px-3 md:px-4 border text-xs md:text-[13px] font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#BFA46A] ${
                isActive
