      ...
      {model.perkIdentity ? (
        ...
        <>
          ...
          <header className="dp-native-detail-panel__summary">
            <p className="dp-native-detail-panel__eyebrow text-[11px] uppercase text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">{model.eyebrow}</p>
