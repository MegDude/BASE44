  ...
  if (isMinimized) {
    return (
      <section className="dp-collection-route-panel dp-collection-route-panel--minimized" aria-label={`${route.title} route minimized`}>
        ...
        >
          <span className="dp-route-mini-kicker text-[11px] uppercase text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">{routeLabel}</span>
      ...
      {checkInStop && typeof document !== "undefined" ? createPortal((
        <div className="dp-route-check-in-backdrop" role="presentation" onMouseDown={(event) => event.target === event.currentTarget && closeCheckIn()}>
          <section className="dp-route-check-in" role="dialog" aria-modal="true" aria-labelledby="dp-route-check-in-title">
            ...
            <p className="dp-route-check-in__eyebrow text-[11px] uppercase text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] text-[11px] uppercase tracking-[0.15em] dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">Route check-in</p>
