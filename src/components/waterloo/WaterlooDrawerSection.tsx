...
export default function WaterlooDrawerSection({ pin, nearby = [] }: { pin: WaterlooParkPin; nearby?: WaterlooParkPin[] }) {
  return (
    <section className="rounded-[8px] border border-[#0B1F33]/[0.08] bg-white p-4">
      ...
      <div className="mt-4">
        <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-[#C8A96A]">Good for</p>
      ...
      {nearby.length > 0 && (
        <div className="mt-4">
          <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-[#C8A96A]">Nearby</p>
