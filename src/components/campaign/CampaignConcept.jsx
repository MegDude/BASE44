    ...
    <section ref={ref} className="py-10 px-5 border-t border-border/40">
      <div className="max-w-6xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7 }} className="mb-8">
          <span className="text-[11px] text-primary/70 uppercase block mb-3 text-[11px] font-bold uppercase tracking-normal">Campaign concept</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <motion.div initial={{ opacity: 0, x: -16 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ delay: 0.1 }}>
            <div className="space-y-6">
              <div>
                <div className="text-[11px] uppercase text-muted-foreground mb-2 text-[11px] font-bold uppercase tracking-normal">Objective</div>
                <p className="text-[14px] text-foreground">{objective}</p>
              </div>
              <div>
                <div className="text-[11px] uppercase text-muted-foreground mb-2 text-[11px] font-bold uppercase tracking-normal">Target audience</div>
                <p className="text-[14px] text-foreground">{audience}</p>
              </div>
              <div>
                <div className="text-[11px] uppercase text-muted-foreground mb-2 text-[11px] font-bold uppercase tracking-normal">Offer / value</div>
          ...
          <motion.div initial={{ opacity: 0, x: 16 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ delay: 0.15 }}>
            <div className="space-y-6">
              <div>
                <div className="text-[11px] uppercase text-muted-foreground mb-2 text-[11px] font-bold uppercase tracking-normal">Primary placements</div>
              ...
              <div>
                <div className="text-[11px] uppercase text-muted-foreground mb-2 text-[11px] font-bold uppercase tracking-normal">Key metrics</div>
