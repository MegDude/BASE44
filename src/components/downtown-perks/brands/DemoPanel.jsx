    ...
    <div className="rounded-xl border border-border/60 bg-card/60 overflow-hidden">
      ...
      <div className="bg-muted/30 h-48 relative">
        ...
        {[
          ...
          >
            <div className={`rounded-xl bg-primary flex items-center justify-center ${dot.size === "lg" ? "w-7 h-7 shadow-lg shadow-primary/30" : "w-3.5 h-3.5 opacity-50"}`}>
      ...
      <div className="p-4 flex items-center gap-3">
        <div className="w-8 h-8 rounded-xl border border-border/60 flex items-center justify-center shrink-0">
...
export function QRDemoPanel({ headline, action, sub }) {
  return (
    <div className="rounded-xl border border-border/60 bg-card/60 p-8 flex flex-col items-center text-center">
      ...
      <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-primary-foreground text-[13px] font-medium">
    ...
    <div className="rounded-xl border border-border/60 bg-card/60 p-5 space-y-2.5">
      ...
      {items.map((item, i) => (
        <div key={i} className="flex items-start gap-3 p-3 rounded-lg bg-muted/30">
          <div className="w-7 h-7 rounded-xl border border-border/60 flex items-center justify-center shrink-0">
