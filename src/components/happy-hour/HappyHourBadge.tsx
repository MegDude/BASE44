...
export default function HappyHourBadge({ state = "Tonight" }: HappyHourBadgeProps) {
  return (
    <span className="inline-flex h-6 items-center rounded-[6px] border border-[#0B1F33]/[0.08] bg-white px-2 text-[#0B1F33]/64 dp-eyebrow text-[11px] font-bold uppercase tracking-[0.15em]">
