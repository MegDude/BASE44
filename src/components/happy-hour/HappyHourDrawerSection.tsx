  ...
  return (
    <section className="rounded-[8px] border border-[#0B1F33]/[0.08] bg-white p-4">
      <div className="flex items-center justify-between gap-3">
        <h3 className="text-[13px] font-semibold uppercase tracking-[0.14em] text-[#0B1F33]/56">Happy Hour</h3>
      ...
      <div className="mt-3 space-y-3">
        {venue.happyHours.map((item, index) => (
          <div key={`${item.days}-${index}`} className="border-t border-[#0B1F33]/[0.06] pt-3 first:border-t-0 first:pt-0">
            ...
            <p className="mt-3 text-[11px] font-semibold uppercase tracking-[0.12em] text-[#C8A96A]">What's on special</p>
