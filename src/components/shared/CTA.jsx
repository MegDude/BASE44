...
export default function CTA({
  ...
  const variants = {
    primary: "border-b border-[#BFA46A]/55 text-[#0B1F33] hover:border-[#BFA46A]",
    secondary: "border-b border-[#0B1F33]/12 text-[#0B1F33]/68 hover:border-[#BFA46A]/55 hover:text-[#0B1F33]",
