      ...
      <div className="p-6 space-y-6">
        ...
        <div className="rounded-lg border border-[#0B1F33]/8 bg-white p-4 shadow-[0_14px_34px_rgba(11,31,51,0.04)]">
          <div className="flex items-start justify-between gap-3">
            ...
            <Link to="/events" className="shrink-0 rounded-md border border-[#0B1F33]/8 bg-white px-3 py-2 text-[11px] font-semibold uppercase tracking-normal text-[#0B1F33]/64 transition hover:border-[#BFA46A]/45 hover:text-[#0B1F33]">
              Add plans
            </Link>
          </div>
                ...
                <div key={event.id} className="rounded-md border border-[#0B1F33]/8 bg-white p-3">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <button
                      ...
                      className="shrink-0 rounded-md border border-[#0B1F33]/8 bg-white px-2.5 py-1.5 text-[10px] font-semibold uppercase tracking-normal text-[#0B1F33]/58 transition hover:border-[#BFA46A]/45 hover:text-[#0B1F33]"
                    >
                      Remove
                    </button>
                  </div>
